// Configuration for DBD Scoreboard Overlay
...
// Refresh interval in milliseconds (set to ~5 seconds)
const FETCH_INTERVAL_MS = 5000;

// CSV parsing row index for the sheet data
const START_ROW_INDEX = 1; // CSV row 2
